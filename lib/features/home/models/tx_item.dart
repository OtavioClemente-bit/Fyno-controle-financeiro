class TxItem {
  static const creditPaymentMethod = 'Crédito';
  static const creditCardBillPaymentMethod = 'Pagamento da fatura';
  ...
  String get _normalizedPaymentMethod => paymentMethod
      .trim()
      .toLowerCase()
      .replaceAll('é', 'e')
      .replaceAll('ê', 'e');

  /// Uma compra no cartão continua sendo uma despesa da sua categoria real.
  bool get isCreditPurchase =>
      !isIncome && _normalizedPaymentMethod == 'credito';

  /// O pagamento da fatura quita compras já contabilizadas e não é uma
  /// segunda despesa.
  bool get isCreditCardBillPayment =>
      !isIncome && _normalizedPaymentMethod == 'pagamento da fatura';

  bool get countsAsExpense => !isIncome && !isCreditCardBillPayment;
