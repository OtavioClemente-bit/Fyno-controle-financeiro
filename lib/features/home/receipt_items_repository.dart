...
class ReceiptItemsRepository {
  ...
  static Future<List<Map<String, Object?>>> getHistoryByNormName(String normName) async {
    final db = await AppDb.instance;
    return db.rawQuery('''
      SELECT id, tx_id, date_ms, raw_name, price, qty, unit, market
      FROM receipt_items
      WHERE norm_name = ?
