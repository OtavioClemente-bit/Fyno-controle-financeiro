...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              fs = context.fs;
              $async$goto = 4;
              return A._asyncAwait(A.WasmSqlite3_loadFromUrlString(uri.toString$0(0), null, null), $async$sqfliteFfiWebLoadSqlite3Wasm);
            case 4:
              // returning from await.
    ...
    WasmSqlite3_loadFromUrlString(url, headers, loader) {
      var $async$goto = 0,
